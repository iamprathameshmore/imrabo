...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:nn,depthTest:!1,depthWrite:!1})}function ea(){return new Sn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:qr(),fragmentShader:`
		...
		`,blending:nn,depthTest:!1,depthWrite:!1})}function ta(){return new Sn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:qr(),fragmentShader:`
...
`].filter(ri).join(`
`)),o=Br(o),o=ua(o,t),o=ha(o,t),a=Br(a),a=ua(a,t),a=ha(a,t),o=da(o),a=da(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(b=`#version 300 es
